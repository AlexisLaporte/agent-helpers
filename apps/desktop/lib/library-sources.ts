import { LibrarySource, LibraryManifest, CustomizationType } from '@agent-helpers/core/types';
...
export function getSourceDirectory(source: LibrarySource): string {
  switch (source.type) {
    case 'bundled':
      // In monorepo: packages/web -> packages/library
      // In Electron: app root -> library
